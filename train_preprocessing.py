...
X_train_features_output_path = os.path.join("/opt/ml/processing/X_train/", "X_train.csv")
X_test_features_output_path = os.path.join("/opt/ml/processing/X_test/", "X_test.csv")
y_train_features_output_path = os.path.join("/opt/ml/processing/y_train/", "y_train.csv")
y_test_features_output_path = os.path.join("/opt/ml/processing/y_test/", "y_test.csv")
